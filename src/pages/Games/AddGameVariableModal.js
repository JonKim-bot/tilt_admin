...
// core components
import { CreateTiltGame ,GameVariablesSet,EditElement} from '../../models/API/API';
...
export default function AddModal(props) {
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      var res = await GameVariablesSet  (props.gameId,form);
        if (res) {
              ...
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div className="modal-content">
                  <div className="modal-header">
                    <h4 className="modal-title" id="myModalLabel33">Add {props.gameId} Variable</h4>
                  ...
                  <form action="#">
                    <div className="modal-body">
                      ...
                      <label>Value: </label>
                      <div className="form-group">
                        <input type="text"  onChange={handleChange}    placeholder="Value" name="Value" className="form-control" />
                      </div>
